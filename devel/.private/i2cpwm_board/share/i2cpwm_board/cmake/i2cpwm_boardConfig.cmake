...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/kevin/catkin_ws/src/ros-i2cpwmboard)
  set(i2cpwm_board_DEVEL_PREFIX /home/kevin/catkin_ws/devel/.private/i2cpwm_board)
  ...
  set(i2cpwm_board_INSTALL_PREFIX /home/kevin/catkin_ws/install)
...
if(NOT "/home/kevin/catkin_ws/devel/.private/i2cpwm_board/include " STREQUAL " ")
  set(i2cpwm_board_INCLUDE_DIRS "")
  set(_include_dirs "/home/kevin/catkin_ws/devel/.private/i2cpwm_board/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kevin/catkin_ws/src/ros-i2cpwmboard/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kevin/catkin_ws/devel/.private/i2cpwm_board/lib;/home/kevin/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
